...
// @Accept       json
// @Produce      json
// @Param        data  body      ChangePassword  true  "login"
// @Success      200   {object}  Message
...
// @Accept       json
// @Produce      json
// @Param        data  body      ForgotPassword  true  "login"
// @Success      200   {object}  Message
...
// @Accept       json
// @Produce      json
// @Param        data  body      UserUpdate  true  "login"
// @Success      200   {object}  Message
...
// @Accept       json
// @Produce      json
// @Param        avatar  body      string  true  "login"
// @Success      200   {object}  Message
