...
docker run -d -p 8080:8080 --name my-video --mount type=bind,source=E:/video/assets,target=/usr/src/app/assets --mount type=bind,source=E:/video/database/sqlite,target=/usr/src/app/database/sqlite my-video:v1
